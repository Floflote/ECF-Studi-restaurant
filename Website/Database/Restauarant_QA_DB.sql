...
--
-- Hôte : localhost:8889
-- Généré le : sam. 18 mars 2023 à 13:15
...
(22, '2023-03-18', '09:54:00', 1, 'testerror@mail.com', 'rien', NULL);
...
--
ALTER TABLE `reservation`
  MODIFY `reservation_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
