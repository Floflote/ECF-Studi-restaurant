...
<section class="table_reservation_section p-5">
  <div class="container-fluid">
    ...
    swal("Réservé", "Votre réservation a bien été prise en compte !", "success").then((value) => {
      window.location.replace("Reserve-table.php.php");
    });
    </script>
        ...
        <div class="row" style="margin-bottom: 1rem;">
          ...
          <div class="col-sm-6">
            ...
            <input type="email" name="customer_email" id="customer_email"
              ...
              placeholder="monmail@mail.com" required>
        ...
        <div class="row" style="margin-bottom: 1rem;">
          <div class="col-sm-6">
            ...
            <textarea name="customer_allergen" class="form-control"
              oninput="document.getElementById('required_allerg').style.display = 'none'" required>
              <?php echo (isset($_POST['customer_allergen'])) ? htmlspecialchars($_POST['customer_allergen']) : ''; ?></textarea>
