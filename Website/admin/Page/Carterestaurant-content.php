                ...
                <ul class="list-inline m-0">
                  ...
                  <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-title="Modifier" data-bs-placement="top">
                    <button class="btn btn-success btn-sm">
                      <a href="Carterestaurant.php?do=Modify&product_id=<?php echo $prodcut['prodcut_id']; ?>" style="color: white;">
                      ...
                      <div class="modal-dialog modal-dialog-centered">
                        ...
                        font-size: 1rem;">
                          ...
                          <div class="modal-footer">
                            ...
                            <button type="button" data-id="<?php echo $product['product_id']; ?>" class="btn btn-warning" id="delete_category_bttn" style="border-radius: 30px; color: white;">Supprimer</button>
                          </div>
                        </div>
                      </div>
                    </div>
...
?>
          ...
          <div class="form-add-product">
            ...
            <div class="form-add-product-body">
              ...
              <div>
                ...
                ?>
                <label for="choice_category">Catégorie</label>
                <select class="form-select" name="choice_category">
                  <?php
              ...
              <div>
                ...
                if (isset($_POST['add_new_product']) && $_SERVER['REQUEST_METHOD'] == 'POST') {
                  ...
                  $extension = end($picture_split);
                  $picture_extension = strtolower($extension);
                ...
                ?>
                  ...
                  if (!empty($_FILES['product_image']['name']) && !in_array($picture_extension, $picture_allowed_extension)) {
                  ?>
                    <div class="invalid-feedback" style="display: block;">
  ...
  if (isset($_POST['add_new_product']) && $_SERVER['REQUEST_METHOD'] == 'POST' && $check_add_product_form == 0) {
    ...
    $picture = rand(0, 100000) . '_' . $_FILES['product_picture']['name'];
    move_uploaded_file($_FILES['product_picture']['tmp_name'], "Picture/" . $picture);
    ...
    try {
      ...
      $statementadddone->execute(array($product_name, $product_description, $product_price, $picture, $product_category));
  ?>
...
elseif ($task == 'Modify') {
  ...
  if ($product_id) {
    ...
    $statementmodify->execute(array($productid));
      ...
      if (isset($_POST['modify_product_sbmt']) && $_SERVER['REQUEST_METHOD'] == 'POST' && $check_modify_product_form == 0) {
        ...
        if (empty($_FILES['product_image']['name'])) {
          try {
            ...
            $statementmodifyone->execute(array($product_name, $product_description, $product_price, $product_category, $product_id));
      ?>
