  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <button class="btn btn-success btn-sm" style="margin-bottom: 10px; border-radius: 30px;" type="button"
        data-bs-toggle="modal" data-bs-target="#add_new_category">
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form>
                ...
                <input type="text" id="category_name_input" class="form-control"
                  onkeyup="this.value=this.value.replace(/[^\sa-zA-Z]/g,'');" placeholder="Sushi" name="category_name">
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-info" style="border-radius: 30px; color: white;"
                id="add_category_bttn">
