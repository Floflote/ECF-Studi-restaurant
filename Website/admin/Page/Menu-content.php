          ...
          <div class="form-add-product">
            ...
            <div class="form-add-product-body">
              ...
              <div style="margin-bottom: 1rem;">
                ...
                <input type="text" class="form-control" onkeyup="this.value=this.value.replace(/[^\sa-zA-Z]/g,'');" value="<?php echo (isset($_POST['menu_name'])) ? htmlspecialchars($_POST['menu_name']) : '' ?>" placeholder="Menu du marché" name="menu_name">
                <?php
              ...
              <div style="margin-bottom: 1rem;">
                ...
                <input type="text" class="form-control" onkeyup="this.value=this.value.replace(/[^\sa-zA-Z]/g,'');" value="<?php echo (isset($_POST['menu_f_options'])) ? htmlspecialchars($_POST['menu_f_options']) : '' ?>" placeholder="Formule du midi" name="menu_f_options">
                <?php
                $check_add_menu_form = 0;
                if (isset($_POST['add_new_menu'])) {
              ...
              <div style="margin-bottom: 1rem;">
                <label for="menu_s_options">Nom de la formule 1</label>
                <input type="text" class="form-control" onkeyup="this.value=this.value.replace(/[^\sa-zA-Z]/g,'');" value="<?php echo (isset($_POST['menu_s_options'])) ? htmlspecialchars($_POST['menu_s_options']) : '' ?>" placeholder="Formule du soir" name="menu_s_options">
              </div>
              ...
              <div style="margin-bottom: 1rem;">
                ...
                <input type="text" class="form-control" value="<?php echo (isset($_POST['menu_s_price'])) ? htmlspecialchars($_POST['menu_s_price']) : '' ?>" placeholder="40.00" name="menu_s_price">
              </div>

              <button type="submit" name="add_new_menu" class="btn btn-info" style="border-radius: 30px; color: white;">
                Ajouter le menu
              </button>
            </div>
          </div>
            ...
            <form method="POST" action="Menu.php?do=Modify&menu_id=<?php echo $menu['menu_id'] ?>" enctype="multipart/form-data">
              <div class="form-add-product">
                ...
                <div class="form-add-product-body">
                  ...
                  <div style="margin-bottom: 1rem;">
                    <label for="menu_name">Nom du menu</label>
                    <input type="text" class="form-control" onkeyup="this.value=this.value.replace(/[^\sa-zA-Z]/g,'');" value="<?php echo $menu['menu_name'] ?>" placeholder="Sushi au thon" name="menu_name">
                    <?php
                  ...
                  <div style="margin-bottom: 1rem;">
                    <label for="menu_f_options">Nom de la formule 1</label>
                    <input type="text" class="form-control" onkeyup="this.value=this.value.replace(/[^\sa-zA-Z]/g,'');" value="<?php echo $menu['menu_f_options'] ?>" placeholder="Formule du midi" name="menu_f_options">
                    <?php
                    $check_modify_menu_form = 0;
                    if (isset($_POST['modify_menu_sbmt'])) {
                      if (empty(test_input($_POST['menu_f_options']))) {
                  ...
                  <div style="margin-bottom: 1rem;">
                    ...
                    <input type="text" class="form-control" onkeyup="this.value=this.value.replace(/[^\sa-zA-Z]/g,'');" value="<?php echo $menu['menu_s_options'] ?>" placeholder="Formule du soir" name="menu_s_options">
                    <?php
                    $check_modify_menu_form = 0;
                    ?>
                  </div>
                  ...
                  <button type="submit" name="modify_menu_sbmt" class="btn btn-info" style="border-radius: 30px; color: white;">
                    Modifier le menu
                  </button>
                </div>
              </div>
