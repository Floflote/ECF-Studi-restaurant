...
--
-- Hôte : localhost:8889
-- Généré le : ven. 10 mars 2023 à 14:49
...
INSERT INTO `customer` (`customer_id`, `customer_mail`, `customer_password`, `customer_allergen`) VALUES
('xab', 'yoyo@mail.com', '12345preee', 'Oeufs, cacahuète'),
('Zdzd', 'mama@mail.com', '12345pzrerr', 'Gluten, lait, plein de trucs ajoutés pour remplir le champ et voir la réaction du tableau');
...
(1, 'Quai Antique', 'quai.antique@mail.com', '0606060606', '1 rue Martin - 00001 Martinville', '12h00 - 14h00 et 19h00 - 22h00', '12h00 - 14h00 et 19h00 - 22h00', 'Ouvert ou pas', '12h00 - 14h00 et 19h00 - 22h00', '12h00 - 14h00 et 19h00 - 22h00', '19h00 - 23h00', '12h00 - 14h00', 200);
...
--
ALTER TABLE `reservation`
  MODIFY `reservation_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
